...
###
        ...
        if bn == 'variable_frequency':
            ...
            output_path = bineural.create_binaural_audio(preset, audio_length, bineural_file_path, bineural_file_title, None, volume=0.1, start_preset=start_freq, mid_preset=mid_freq, end_preset=end_freq)                    
