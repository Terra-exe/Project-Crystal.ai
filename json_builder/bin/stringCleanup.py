...
def segmentTextForTime(inputText):
    ...
    "<CROWNBELL>", "<3RDEYEBELL>", "<THROATBELL>", "<HEARTBELL>", "<SOLARBELL>", "<SACRALBELL>", "<ROOTBELL>", "<OHITSYOU>", "<POP2>", "<GRIMES_ANY_SUFFICIENTLY_ADVANCED_GLADOS>", "<MUTELUNATIC>", "<ITSDANGEROUS>"
    ]
