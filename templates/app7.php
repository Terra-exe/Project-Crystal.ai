...
<html lang="en">
  <head>
    ...
    <title>Audio / to MP4 - Youtube Submit"</title>
  </head>

{% include "navbar.php" %}
{% include "pagetitle.php" %}
<h>Audio / to MP4 - Youtube Submit"</h>
<body>
<form id="my-form" method="POST" enctype="multipart/form-data">
		...
		<details>
			<summary>Instructions</summary>
                <ul>
                    <li>Convert to MP4 - Youtube Submit"</li>
                </ul>
		</details>
		<br><br>
		<div>
    ...
    <script>
        ...
        function downloadButtonClickHandler(event) {
            ...
            const audioFileName = `${audioFileTitle}.mp4`;
        ...
        form.addEventListener('submit', function(event) {
            ...
            xhr.open('POST', '/app7/upload_to_youtube', true); // adjust the URL if necessary
